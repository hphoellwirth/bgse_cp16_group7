...
if (interactive) {
    ...
    data <- read.csv('concentration.csv', sep = ';', 
...
# ----------------------------------------------------------------------
invisible(dbGetQuery(dbConn, "DELETE FROM forecastConcentration"))
...
query <- paste("INSERT INTO forecastConcentration",
